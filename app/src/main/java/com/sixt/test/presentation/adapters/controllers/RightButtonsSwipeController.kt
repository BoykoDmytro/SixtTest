package com.sixt.test.presentation.adapters.controllers
...
import com.sixt.test.common.AndroidUtils
...
class RightButtonsSwipeController(
    ...
    override fun drawViews(canvas: Canvas, viewHolder: RecyclerView.ViewHolder) {
        ...
        val bitmapDelete = getBitmapForIcon(itemView.context, android.R.drawable.ic_delete)
        val bitmapExport = getBitmapForIcon(itemView.context, android.R.drawable.ic_menu_edit)
